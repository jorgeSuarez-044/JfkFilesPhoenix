...
const azureButtonFor =
  (hiddenProps: HiddenProps): React.StatelessComponent<ButtonProps> =>
  (props) => {
    return (
      <Hidden {...hiddenProps}>
        <Button
...
export const AzureButtonComponent: React.StatelessComponent<ButtonProps> = (
  props
) => {
  return (
    <>
